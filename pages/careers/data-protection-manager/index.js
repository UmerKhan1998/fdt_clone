...
const index = () => {
  ...
  const t2 = useTranslations("Job_description4");
          ...
          <div className={styles.CareesDetail_top}>
            <div className={styles.CareesDetail_left}>
              ...
              <ul>
                ...
                <li>{t2("ResponsibilitiesItem11")}</li>
                <li>{t2("ResponsibilitiesItem12")}</li>
                <li>{t2("ResponsibilitiesItem13")}</li>
                <li>{t2("ResponsibilitiesItem14")}</li>
                <li>{t2("ResponsibilitiesItem15")}</li>
                <li>{t2("ResponsibilitiesItem16")}</li>
                <li>{t2("ResponsibilitiesItem17")}</li>
              </ul>
              ...
              <ul>
                ...
                <li>{t2("RequirementsItem8")}</li>
                <li>{t2("RequirementsItem9")}</li>
                <li>{t2("RequirementsItem10")}</li>
                <li>{t2("RequirementsItem11")}</li>
                <li>{t2("RequirementsItem12")}</li>
                <li>{t2("RequirementsItem13")}</li>
                <li>{t2("RequirementsItem14")}</li>
                <li>{t2("RequirementsItem15")}</li>
              </ul>
